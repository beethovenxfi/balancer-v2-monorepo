...
contract TarotLinearPool is LinearPool, TarotShareValueHelper, Version {
    ...
    constructor(ConstructorArgs memory args)
        ...
        TarotShareValueHelper(args.wrappedToken)
    {
        _require(
            address(args.mainToken) ==
                address(ITarotSupplyVault(address(args.wrappedToken)).underlying()),
