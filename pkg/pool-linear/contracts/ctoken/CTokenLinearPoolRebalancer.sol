...
contract CTokenLinearPoolRebalancer is LinearPoolRebalancer {
    ...
    function _getRequiredTokensToWrap(uint256 wrappedAmount) internal view override returns (uint256) {
        // Since this function is view, we cannot leverage exchangeRateCurrent to accrue any owed interest.
        // As interest is accrued on a call to mint, this means that a call to rebalance must be preceeded by a call
        // to exchangeRateCurrent in order to ensure the correct main amount is calculated here.
