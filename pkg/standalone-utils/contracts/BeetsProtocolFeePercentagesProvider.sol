...
contract BeetsProtocolFeePercentagesProvider is IProtocolFeePercentagesProvider, SingletonAuthentication {
    ...
    function unsetFeeTypePercentageForPool(address poolAddress, uint256 feeType)
        external
        withValidFeeType(feeType)
        authenticate
    {
