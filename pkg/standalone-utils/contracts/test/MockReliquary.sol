...
import "@balancer-labs/v2-solidity-utils/contracts/openzeppelin/ERC721Burnable.sol";
import "@balancer-labs/v2-solidity-utils/contracts/openzeppelin/ERC721Enumerable.sol";
import "@balancer-labs/v2-solidity-utils/contracts/openzeppelin/Multicall.sol";
    ...
    ReentrancyGuard
{
    ...
    address[] override public nftDescriptor;
    /// @notice Address of EmissionCurve contract.
    address override public emissionCurve;
    // Info of each Reliquary pool.
    PoolInfo[] private poolInfo;
    // Level system for each Reliquary pool.
    LevelInfo[] private levels;
    /// @notice Address of the LP token for each Reliquary pool.
    address[] override public poolToken;
    /// @notice Address of IRewarder contract for each Reliquary pool.
    address[] override public rewarder;

    // Info of each staked position.
    ...
    function setEmissionCurve(address _emissionCurve) external override {
