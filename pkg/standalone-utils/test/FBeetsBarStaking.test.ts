...
describe('FBeetsBarStaking', function () {
  ...
  sharedBeforeEach('deploy Vault and BeetsBar', async () => {
  ...
  sharedBeforeEach('set up relayer', async () => {
    ...
    relayerLibrary = await deploy('MockBatchRelayerLibrary', {
      args: [vault.address, ZERO_ADDRESS, ZERO_ADDRESS, ZERO_ADDRESS, ZERO_ADDRESS, fbeets.address, ZERO_ADDRESS],
    });
  ...
  //   // Deploy Relayer
  //   relayerLibrary = await deploy('MockBatchRelayerLibrary', {
  //     args: [vault.address, ZERO_ADDRESS, ZERO_ADDRESS, ZERO_ADDRESS, ZERO_ADDRESS, ZERO_ADDRESS],
  //   });
  //   relayer = await deployedAt('BalancerRelayer', await relayerLibrary.getEntrypoint());
